...
export function Dashboard1(props: DashboardProps) {
    return (
        <div className="zenux-dashboard dashboard1">
            <div className="sidebar">
                <div className="sidebar-header hide-on-collapse">
                    {props.title}
                </div>
                <div className="navitems">
                    {props.menuItems.map((props, idx) => (
            ...
            <div className="pagewrap">
                ...
                <div className="mainwrap">{props.children}</div>
            </div>
        </div>
    );
}
